/* 
 * File:   NegativeSample.h
 * Author: Nils Frenking
 *
 * Created on 10. Januar 2013, 13:42
 */

#ifndef NEGATIVESAMPLE_H
#define	NEGATIVESAMPLE_H
#include "../header.h"

using namespace std;
using namespace cv;

class NegativeSample : public CreationBehavior {
public:
    NegativeSample();
    NegativeSample(const NegativeSample& orig);
    virtual ~NegativeSample();
    /**
     ...
     *          
     */
    virtual void createImageInfo(CvArrayOfStringArrays input, String output, CvStringArray backgroundImagePath, bool createMarkedOutputFiles = false);
private:

};

#endif	/* NEGATIVESAMPLE_H */
