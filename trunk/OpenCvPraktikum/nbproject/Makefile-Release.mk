...
${OBJECTDIR}/Objects/ExtendedImageAttributes.o: Objects/ExtendedImageAttributes.cpp 
	...
	${RM} $@.d
	$(COMPILE.cc) -Wall -I/usr/local/include/opencv -I/usr/local/include/opencv2 `pkg-config --cflags opencv` -std=c++11   -MMD -MP -MF $@.d -o ${OBJECTDIR}/Objects/ExtendedImageAttributes.o Objects/ExtendedImageAttributes.cpp
...
${OBJECTDIR}/Helper/TwoFingersPositiveSample.o: Helper/TwoFingersPositiveSample.cpp 
	...
	${RM} $@.d
	$(COMPILE.cc) -Wall -I/usr/local/include/opencv -I/usr/local/include/opencv2 `pkg-config --cflags opencv` -std=c++11   -MMD -MP -MF $@.d -o ${OBJECTDIR}/Helper/TwoFingersPositiveSample.o Helper/TwoFingersPositiveSample.cpp

${OBJECTDIR}/Helper/SampleCreator.o: Helper/SampleCreator.cpp 
	${MKDIR} -p ${OBJECTDIR}/Helper
	${RM} $@.d
	$(COMPILE.cc) -Wall -I/usr/local/include/opencv -I/usr/local/include/opencv2 `pkg-config --cflags opencv` -std=c++11   -MMD -MP -MF $@.d -o ${OBJECTDIR}/Helper/SampleCreator.o Helper/SampleCreator.cpp
...
${OBJECTDIR}/Helper/FourFingersPositveSample.o: Helper/FourFingersPositveSample.cpp 
	${MKDIR} -p ${OBJECTDIR}/Helper
	${RM} $@.d
	$(COMPILE.cc) -Wall -I/usr/local/include/opencv -I/usr/local/include/opencv2 `pkg-config --cflags opencv` -std=c++11   -MMD -MP -MF $@.d -o ${OBJECTDIR}/Helper/FourFingersPositveSample.o Helper/FourFingersPositveSample.cpp

${OBJECTDIR}/Objects/HistogramCreationMethod.o: Objects/HistogramCreationMethod.cpp 
	${MKDIR} -p ${OBJECTDIR}/Objects
	${RM} $@.d
	$(COMPILE.cc) -Wall -I/usr/local/include/opencv -I/usr/local/include/opencv2 `pkg-config --cflags opencv` -std=c++11   -MMD -MP -MF $@.d -o ${OBJECTDIR}/Objects/HistogramCreationMethod.o Objects/HistogramCreationMethod.cpp
...
${OBJECTDIR}/Test/CreateNegativeSamplesTest.o: Test/CreateNegativeSamplesTest.cpp 
	${MKDIR} -p ${OBJECTDIR}/Test
	${RM} $@.d
	$(COMPILE.cc) -Wall -I/usr/local/include/opencv -I/usr/local/include/opencv2 `pkg-config --cflags opencv` -std=c++11   -MMD -MP -MF $@.d -o ${OBJECTDIR}/Test/CreateNegativeSamplesTest.o Test/CreateNegativeSamplesTest.cpp
...
${OBJECTDIR}/Test/CreatePositiveSamplesTest.o: Test/CreatePositiveSamplesTest.cpp 
	${MKDIR} -p ${OBJECTDIR}/Test
	${RM} $@.d
	$(COMPILE.cc) -Wall -I/usr/local/include/opencv -I/usr/local/include/opencv2 `pkg-config --cflags opencv` -std=c++11   -MMD -MP -MF $@.d -o ${OBJECTDIR}/Test/CreatePositiveSamplesTest.o Test/CreatePositiveSamplesTest.cpp
...
${OBJECTDIR}/Test/WindowManagerTest.o: Test/WindowManagerTest.cpp 
	${MKDIR} -p ${OBJECTDIR}/Test
	${RM} $@.d
	$(COMPILE.cc) -Wall -I/usr/local/include/opencv -I/usr/local/include/opencv2 `pkg-config --cflags opencv` -std=c++11   -MMD -MP -MF $@.d -o ${OBJECTDIR}/Test/WindowManagerTest.o Test/WindowManagerTest.cpp
...
${OBJECTDIR}/Helper/FistPositiveSample.o: Helper/FistPositiveSample.cpp 
	${MKDIR} -p ${OBJECTDIR}/Helper
	${RM} $@.d
	$(COMPILE.cc) -Wall -I/usr/local/include/opencv -I/usr/local/include/opencv2 `pkg-config --cflags opencv` -std=c++11   -MMD -MP -MF $@.d -o ${OBJECTDIR}/Helper/FistPositiveSample.o Helper/FistPositiveSample.cpp
...
${OBJECTDIR}/Test/VideoInputToImageSequenceOutputTest.o: Test/VideoInputToImageSequenceOutputTest.cpp 
	${MKDIR} -p ${OBJECTDIR}/Test
	${RM} $@.d
	$(COMPILE.cc) -Wall -I/usr/local/include/opencv -I/usr/local/include/opencv2 `pkg-config --cflags opencv` -std=c++11   -MMD -MP -MF $@.d -o ${OBJECTDIR}/Test/VideoInputToImageSequenceOutputTest.o Test/VideoInputToImageSequenceOutputTest.cpp
...
${OBJECTDIR}/View/WindowManager.o: View/WindowManager.cpp 
	${MKDIR} -p ${OBJECTDIR}/View
	${RM} $@.d
	$(COMPILE.cc) -Wall -I/usr/local/include/opencv -I/usr/local/include/opencv2 `pkg-config --cflags opencv` -std=c++11   -MMD -MP -MF $@.d -o ${OBJECTDIR}/View/WindowManager.o View/WindowManager.cpp
...
${OBJECTDIR}/Objects/MaskCreationMethod.o: Objects/MaskCreationMethod.cpp 
	${MKDIR} -p ${OBJECTDIR}/Objects
	${RM} $@.d
	$(COMPILE.cc) -Wall -I/usr/local/include/opencv -I/usr/local/include/opencv2 `pkg-config --cflags opencv` -std=c++11   -MMD -MP -MF $@.d -o ${OBJECTDIR}/Objects/MaskCreationMethod.o Objects/MaskCreationMethod.cpp

${OBJECTDIR}/Helper/ThumbUpPositiveSample.o: Helper/ThumbUpPositiveSample.cpp 
	${MKDIR} -p ${OBJECTDIR}/Helper
	${RM} $@.d
	$(COMPILE.cc) -Wall -I/usr/local/include/opencv -I/usr/local/include/opencv2 `pkg-config --cflags opencv` -std=c++11   -MMD -MP -MF $@.d -o ${OBJECTDIR}/Helper/ThumbUpPositiveSample.o Helper/ThumbUpPositiveSample.cpp

${OBJECTDIR}/Helper/CreationBehavior.o: Helper/CreationBehavior.cpp 
	${MKDIR} -p ${OBJECTDIR}/Helper
	${RM} $@.d
	$(COMPILE.cc) -Wall -I/usr/local/include/opencv -I/usr/local/include/opencv2 `pkg-config --cflags opencv` -std=c++11   -MMD -MP -MF $@.d -o ${OBJECTDIR}/Helper/CreationBehavior.o Helper/CreationBehavior.cpp
...
${OBJECTDIR}/View/AImageAction.o: View/AImageAction.cpp 
	${MKDIR} -p ${OBJECTDIR}/View
	${RM} $@.d
	$(COMPILE.cc) -Wall -I/usr/local/include/opencv -I/usr/local/include/opencv2 `pkg-config --cflags opencv` -std=c++11   -MMD -MP -MF $@.d -o ${OBJECTDIR}/View/AImageAction.o View/AImageAction.cpp

${OBJECTDIR}/Helper/ThreeFingersPositiveSample.o: Helper/ThreeFingersPositiveSample.cpp 
	${MKDIR} -p ${OBJECTDIR}/Helper
	${RM} $@.d
	$(COMPILE.cc) -Wall -I/usr/local/include/opencv -I/usr/local/include/opencv2 `pkg-config --cflags opencv` -std=c++11   -MMD -MP -MF $@.d -o ${OBJECTDIR}/Helper/ThreeFingersPositiveSample.o Helper/ThreeFingersPositiveSample.cpp
...
${OBJECTDIR}/Objects/ContourCreationMethod.o: Objects/ContourCreationMethod.cpp 
	${MKDIR} -p ${OBJECTDIR}/Objects
	${RM} $@.d
	$(COMPILE.cc) -Wall -I/usr/local/include/opencv -I/usr/local/include/opencv2 `pkg-config --cflags opencv` -std=c++11   -MMD -MP -MF $@.d -o ${OBJECTDIR}/Objects/ContourCreationMethod.o Objects/ContourCreationMethod.cpp

${OBJECTDIR}/Helper/PlainHandPositiveSample.o: Helper/PlainHandPositiveSample.cpp 
	${MKDIR} -p ${OBJECTDIR}/Helper
	${RM} $@.d
	$(COMPILE.cc) -Wall -I/usr/local/include/opencv -I/usr/local/include/opencv2 `pkg-config --cflags opencv` -std=c++11   -MMD -MP -MF $@.d -o ${OBJECTDIR}/Helper/PlainHandPositiveSample.o Helper/PlainHandPositiveSample.cpp

${OBJECTDIR}/Objects/PixelObject.o: Objects/PixelObject.cpp 
	${MKDIR} -p ${OBJECTDIR}/Objects
	${RM} $@.d
	$(COMPILE.cc) -Wall -I/usr/local/include/opencv -I/usr/local/include/opencv2 `pkg-config --cflags opencv` -std=c++11   -MMD -MP -MF $@.d -o ${OBJECTDIR}/Objects/PixelObject.o Objects/PixelObject.cpp

${OBJECTDIR}/Modifier/BgFgSegmModificator.o: Modifier/BgFgSegmModificator.cpp 
	${MKDIR} -p ${OBJECTDIR}/Modifier
	${RM} $@.d
	$(COMPILE.cc) -Wall -I/usr/local/include/opencv -I/usr/local/include/opencv2 `pkg-config --cflags opencv` -std=c++11   -MMD -MP -MF $@.d -o ${OBJECTDIR}/Modifier/BgFgSegmModificator.o Modifier/BgFgSegmModificator.cpp
