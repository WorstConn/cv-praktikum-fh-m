...
${OBJECTDIR}/Helper/PositiveSample.o: Helper/PositiveSample.cpp 
	${MKDIR} -p ${OBJECTDIR}/Helper
	${RM} $@.d
	$(COMPILE.cc) -Wall -I/usr/local/include/opencv -I/usr/local/include/opencv2 `pkg-config --cflags opencv` -std=c++11   -MMD -MP -MF $@.d -o ${OBJECTDIR}/Helper/PositiveSample.o Helper/PositiveSample.cpp
