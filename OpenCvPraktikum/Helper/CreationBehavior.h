/* 
 * File:   CreationBehavior.h
 * Author: Nils Frenking
 *
 * Created on 10. Januar 2013, 12:00
 */

#ifndef CREATIONBEHAVIOR_H
#define	CREATIONBEHAVIOR_H
#include "../header.h"
...
public:
    CreationBehavior();
    CreationBehavior(const CreationBehavior& orig);
    virtual ~CreationBehavior();
    /**
     ...
     *          
     */
    virtual String createImageInfo(Mat& img, String imgPath, int pos = -1) = 0;
     ...
     *          
     */
    virtual void createImageInfo(ArrayOfStringArrays input, String output, StringArray backgroundImagePath, bool createMarkedOutputFiles = false, bool presegmentedData = false) = 0;
    virtual bool presegmentedData();
protected:
    virtual String iToStr(int i);
    bool usePresegmentedData;
