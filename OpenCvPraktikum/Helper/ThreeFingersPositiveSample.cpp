...
ThreeFingersPositiveSample::ThreeFingersPositiveSample() {
}

ThreeFingersPositiveSample::ThreeFingersPositiveSample(const ThreeFingersPositiveSample& orig) : CreationBehavior(orig) {
}
 ...
 *          
 */
String ThreeFingersPositiveSample::createImageInfo(Mat& img, String imgPath, int pos) {
 ...
 *          
 */
void ThreeFingersPositiveSample::createImageInfo(ArrayOfStringArrays input, String output, StringArray backgroundImagePath, bool createMarkedOutputFiles, bool presegmentedData) {
