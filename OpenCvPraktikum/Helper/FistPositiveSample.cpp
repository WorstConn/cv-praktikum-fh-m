...
FistPositiveSample::FistPositiveSample() {
}

FistPositiveSample::FistPositiveSample(const FistPositiveSample& orig) : CreationBehavior(orig) {
}
 ...
 *          
 */
String FistPositiveSample::createImageInfo(Mat& img, String imgPath, int pos) {
    ...
    int tmpY = minY.y + tmpW + static_cast<int> (((((float) tmpW)*0.05f)));
 ...
 *          
 */
void FistPositiveSample::createImageInfo(ArrayOfStringArrays input, String output, StringArray backgroundImagePath, bool createMarkedOutputFiles, bool presegmentedData) {
